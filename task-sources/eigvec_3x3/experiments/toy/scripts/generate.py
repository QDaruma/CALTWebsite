"""Generate the eigvec_3x3 dataset for the toy experiment."""
...
from eigvec_3x3.core.generator import Eigvec3x3Generator
...
def main(config_path: str | None) -> None:
    ...
    problem_generator = Eigvec3x3Generator(**gen_cfg)
